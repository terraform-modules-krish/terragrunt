...
- `extra_arguments` (block): Nested blocks used to specify extra CLI arguments to pass to the `terraform` CLI. Learn more
  about its usage in the [Keep your CLI flags DRY](https://github.com/terraform-modules-krish/terragrunt/blob/v0.22.0/use-cases/keep-your-cli-flags-dry/) use case overview. Supports
...
DRY](https://github.com/terraform-modules-krish/terragrunt/blob/v0.22.0/use-cases/keep-your-remote-state-configuration-dry) use case overview.
...
section](https://github.com/terraform-modules-krish/terragrunt/blob/v0.22.0/use-cases/keep-your-remote-state-configuration-dry/#filling-in-remote-state-settings-with-terragrunt) of the
...
You can learn more about locals in the [feature overview](https://github.com/terraform-modules-krish/terragrunt/blob/v0.22.0/docs/features/locals/).
...
section](https://github.com/terraform-modules-krish/terragrunt/blob/v0.22.0/use-cases/execute-terraform-commands-on-multiple-modules-at-once/#dependencies-between-modules) of the
