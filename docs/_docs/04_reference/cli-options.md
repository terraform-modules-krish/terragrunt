...
commands on multiple modules at once](https://github.com/terraform-modules-krish/terragrunt/blob/v0.27.0/docs/features/execute-terraform-commands-on-multiple-modules-at-once/) for 
context.
...
[`dependency`](https://github.com/terraform-modules-krish/terragrunt/blob/v0.27.0/docs/reference/config-blocks-and-attributes/#dependency) and
[`dependencies`](https://github.com/terraform-modules-krish/terragrunt/blob/v0.27.0/docs/reference/config-blocks-and-attributes/#dependencies) blocks. 
...
the dependency graph based on [`dependency`](https://github.com/terraform-modules-krish/terragrunt/blob/v0.27.0/docs/reference/config-blocks-and-attributes/#dependency) and
[`dependencies`](https://github.com/terraform-modules-krish/terragrunt/blob/v0.27.0/docs/reference/config-blocks-and-attributes/#dependencies) blocks. This may produce output such as:
