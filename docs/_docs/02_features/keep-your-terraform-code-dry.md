...
`terraform` using the [generate block](https://github.com/terraform-modules-krish/terragrunt/blob/v0.23.27/docs/reference/config-blocks-and-attributes#generate). This can be used to
